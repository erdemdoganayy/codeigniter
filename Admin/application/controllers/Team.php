...
class Team extends CI_Controller {
	...
	public function insertTeam () {
		...
		$teamFacebook 		= $this->input->post("teamFacebook");
		$teamTwitter 		= $this->input->post("teamTwitter");
		$teamLinkedin 		= $this->input->post("teamLinkedin");
		$teamGoogle 		= $this->input->post("teamGoogle");
		if (!$teamName || !$teamDegree || !$teamFacebook || !$teamTwitter || !$teamLinkedin || !$teamGoogle ) {
			$alert	= array(
				"title" 	=> "Dikkat !",
