									...
									<div class="modal-dialog modal-lg" role="document" >
										<div class="modal-content">
											...
											<div class="modal-body">
												<p class="small">Yeni Haber Oluşturmak İçin Bilgileri Eksiksiz Doldurunuz</p>
												<!-- FORM -->
												<form action="<?=base_url("News/insertNews") ?>" method="POST" enctype="multipart/form-data">
													<div class="row">
														...
														<div class="col-md-12">
															<div class="form-group form-group-default">
																<label>Başlık</label>
																<input id="addOffice" type="text" class="form-control" placeholder="Lütfen Başlık Giriniz" name="newsTitle">
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group form-group-default">
														...
														<div class="col-md-12">
															<div class="alert alert-info">
																<p><b>Bilgi :  </b>Yazdığınız Her Etiketi Virgül(,) İle Ayırın.</p>
																<p><b>Örneğin : </b> Seo, Haber, Firma, WebSitesi, Blog</p>
															</div>
															<div class="form-group form-group-default">
																<label>Seo Etiketler</label>
																<input id="addOffice" type="text" class="form-control" placeholder="Lütfen Seo Etiket Giriniz" name="newsSeoTags">
															</div>
														</div>
													...
													<tr id="rank=<?=$data->newsID; ?>">
														...
														<td>
															<div class="form-button-action">
																...
																data-target="#editRowModal<?=$data->newsID ?>" title="" class="btn btn-primary btn-sm" data-original-title="Düzenle">
											...
											<div class="modal fade" id="editRowModal<?=$data->newsID ?>" tabindex="-1" role="dialog" aria-hidden="true">
												<div class="modal-dialog modal-lg" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p class="small">Haberi Düzenlemek İçin Bilgileri Eksiksiz Doldurunuz</p>
															<!-- FORM -->
															<form action="<?=base_url("news/updateNews/").$data->newsID ?>" method="POST" enctype="multipart/form-data">
																<div class="row">
																	...
																	<div class="col-md-12">
																		<div class="form-group form-group-default">
																			<label>Başlık</label>
																			<input id="addOffice" type="text" class="form-control" placeholder="Lütfen Başlık Giriniz" name="newsTitle" value="<?=$data->newsTitle?>">
																		</div>
																	</div>
																	<div class="col-md-12">
																		<div class="form-group form-group-default">
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group form-group-default">
																			<label>Seo Etiketler</label>
																			<input id="addOffice" type="text" class="form-control" placeholder="Lütfen Seo Etiket Giriniz" name="newsSeoTags" value="<?=$data->newsSeoTags?>">
																		</div>
																	</div>
