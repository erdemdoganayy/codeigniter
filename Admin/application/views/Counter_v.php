						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">İstatistikler Listesi</h4>
									...
									<div class="modal-dialog modal-lg" role="document" >
										<div class="modal-content">
											...
											<div class="modal-body">
												<p class="small">Yeni İstatistik Oluşturmak İçin Bilgileri Eksiksiz Doldurunuz</p>
												<!-- FORM -->
													...
													<tr id="rank=<?=$data->counterID; ?>">
														...
														<td>
															<div class="form-button-action">
																...
																data-target="#editRowModal<?=$data->counterID ?>" title="" class="btn btn-primary btn-sm" data-original-title="Düzenle">
											...
											<div class="modal fade" id="editRowModal<?=$data->counterID ?>" tabindex="-1" role="dialog" aria-hidden="true">
												<div class="modal-dialog modal-lg" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p class="small">İstatistikları Düzenlemek İçin Bilgileri Eksiksiz Doldurunuz</p>
															<!-- FORM -->
															<form action="<?=base_url("counter/updateCounter/").$data->counterID ?>" method="POST" enctype="multipart/form-data">
																<div class="row">
																	<div class="col-sm-12">
																		<div class="form-group form-group-default">
																			<label>Mevcut İcon</label>
