									...
									<div class="modal-dialog modal-lg" role="document" >
										<div class="modal-content">
											...
											<div class="modal-body">
												<p class="small">Yeni Hizmet Oluşturmak İçin Bilgileri Eksiksiz Doldurunuz</p>
												<!-- FORM -->
													...
													<tr id="rank=<?=$data->servicesID; ?>">
														...
														<td>
															<div class="form-button-action">
																...
																data-target="#editRowModal<?=$data->servicesID ?>" title="" class="btn btn-primary btn-sm" data-original-title="Düzenle">
											...
											<div class="modal fade" id="editRowModal<?=$data->servicesID ?>" tabindex="-1" role="dialog" aria-hidden="true">
												<div class="modal-dialog modal-lg" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<p class="small">Hizmetlerinizi Düzenlemek İçin Bilgileri Eksiksiz Doldurunuz</p>
															<!-- FORM -->
