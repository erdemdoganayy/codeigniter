												...
												<form action="<?php echo base_url("sliders/insertSlider") ?>" method="POST" enctype="multipart/form-data">
													<div class="row">
														...
														<div class="col-md-12">
															<div class="form-group form-group-default">
																<label>Başlık</label>
																<input id="addOffice" type="text" class="form-control" placeholder="Başlık Giriniz" name="sliderTitle">
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group form-group-default">
															...
															<form action="<?php echo base_url("Sliders/updateSlider/").$data->sliderID ?>" method="POST" enctype="multipart/form-data">
																<div class="row">
																	...
																	<div class="col-md-12">
																		<div class="form-group form-group-default">
																			<label>Başlık</label>
																			<input id="addOffice" type="text" class="form-control" placeholder="Sol Butonun İsmini Giriniz" name="sliderTitle" value="<?php echo $data->sliderTitle; ?>">
																		</div>
																	</div>
																	<div class="col-md-12">
																		<div class="form-group form-group-default">
