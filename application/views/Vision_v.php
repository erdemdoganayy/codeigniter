	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="breadcrumb">
				<ul>
					<li><a href="<?=base_url("Vision")?>">Home</a></li>
					<li>Vision</li>
				</ul>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<a href="#" class="img-about">
					<img src="<?=base_url()?>Admin/uploads/<?=$vision[0]->visionImage?>" alt="" class="img-responsive">
				</a>
			</div>
			<div class="col-md-6">
				<!-- About text-->
				<div class="about-details">
					<h5><?=$vision[0]->visionTitle?></h5>
					<p><?=$vision[0]->visionContent?></p>
